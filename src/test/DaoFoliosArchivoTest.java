...
//			/*
//			DAOFoliosArchivo dao = new DAOFoliosArchivo();
...
//	}
//
//	// metodo que prueba el metodo insert de DAOFoliosArchivo
...
//
//		if(!error)
//			System.out.println("Test DAOFoliosArchivo.insert OK");
//	}
//
//	// metodo que prueba el metodo delete de DAOFoliosArchivo
...
//
//		if(!error)
//			System.out.println("Test DAOFoliosArchivo.delete OK");
//	}
//
//	// metodo que prueba el metodo member de DAOFoliosArchivo
...
//
//		if(!error)
//			System.out.println("Test DAOFoliosArchivo.memeber OK");
//	}
//
//	// metodo que prueba el metodo find de DAOFoliosArchivo
...
//		dao.delete("Folio_1");
//
//		//TODO:Arreglar en clase DAOFoliosArchivo
//		System.out.println("ERROR:Cuando se obtiene un folio no se estan obteniendo sus revisiones");
//		error = true;
//		
//		if(!error)
//			System.out.println("Test DAOFoliosArchivo.find OK");
//	}
//	
//	// metodo que prueba el metodo listarFolios de DAOFoliosArchivo
...
//
//		if(!error)
//			System.out.println("Test DAOFoliosArchivo.listarFolios OK");
//	}
//
//	// metodo que prueba el metodo esvacio de DAOFoliosArchivo
...
//
//		if (!error)
//			System.out.println("Test DAOFoliosArchivo.esVacio OK");
//	}
//
//	// metodo que prueba el metodo folioMasRevisado de DAOFoliosArchivo
...
//		 * ***No puedo continuar el test, no hay forma de insertar una revision desde DAOFoliosArchivo
//		 * 
//		 * 
//		 */
//		
...
//
//		if (!error)
//			System.out.println("Test DAOFoliosArchivo.folioMasRevisado OK");
//	}
//
//}
